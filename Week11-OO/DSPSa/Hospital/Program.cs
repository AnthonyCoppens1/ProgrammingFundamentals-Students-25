...
namespace Hospital
{
    internal class Program
    {
        ...
        {
            Doctor Anthony = new Doctor("Anthony Coppens", new DateOnly(1995, 07, 31), 'M', "Cardiovascular");
            Doctor Harkirat = new Doctor("Harkirat Dhanoa", new DateOnly(2006, 09, 23), 'M', "Cardiologist");
            Person John = new Person();
            Nurse Joseph = new Nurse("Joseph Duku", new DateOnly(2004, 10, 11), 'M', "The EYE department");
            Nurse Milton = new Nurse("Milton Tahlah", new DateOnly(2005, 06, 21), 'M', "weird ER situations");
